...
# ImpMagneticCard
ant -f runbatch.xml runFtpIn -Ddate=$RUN_DATE -DfileName=MAGNETICMAP
ant -f runbatch.xml runFilesIn -Ddate=$RUN_DATE -DfileName=MAGNETICMAP
ant -f runbatch.xml runImpMagneticCard -Ddate=$RUN_DATE
